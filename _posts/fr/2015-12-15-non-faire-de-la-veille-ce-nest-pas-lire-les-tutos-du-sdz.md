 ...
 *  Windows: [RSSOwl](http://www.rssowl.org/), [FeedReader](http://feedreader.com/download){:rel="nofollow noreferrer"}
 *  Linux: [RSSOwl](http://www.rssowl.org/){:rel="nofollow noreferrer"}
 *  MacOs: [RSSOwl](http://www.rssowl.org/){:rel="nofollow noreferrer"}
...
Si vous désirez avant tout être au courant très rapidement des nouveautés je vous conseille donc de sélectionner soigneusement vos sources afin d'être sûr de pouvoir tout dépiler et de ne pas prendre de retard. Par exemple faire attention à ne pas avoir trop de "gros" sites de news qui fournissent énormément de contenu chaque jours ([Numerama](http://www.numerama.com/), [Nextinpact](http://www.nextinpact.com/),...) et plutôt sélectionner de plus "petits" sites mais plus spécialisés qui vous permettront de bien suivre ce que vous désirez (type blog par exemple){:rel="nofollow noreferrer"}.

Si l'on garde l'exemple d'un développeur PHP, on pourrait donc imaginer vouloir suivre les flux suivants:

- [php.net](http://www.php.net/) (la bible){:rel="nofollow noreferrer"}, qui permet de suivre toutes les nouveautés de PHP ainsi que les grosses failles de sécurité.
- [blog.ircmaxell.com](http://blog.ircmaxell.com/){:rel="nofollow noreferrer"} dev influent dans l'univers de PHP
- [akrabat.com](https://akrabat.com/){:rel="nofollow noreferrer"} idem
- [symfony.com/blog](http://symfony.com/blog/){:rel="nofollow noreferrer"} si vous êtes intéressé par les nouveautés concernant le framework Symfony
- [news.ycombinator.com](https://news.ycombinator.com/){:rel="nofollow noreferrer"} site qui regroupe beaucoup de news concernant l'informatique en général
- [journalduhacker.net](https://www.journalduhacker.net/){:rel="nofollow noreferrer"} idem mais version française

Ce peut-être une bonne base pour commencer! Si vous souhaitez en découvrir d'autres voici mon fichier opml (export de la liste des flux que je suis actuellement): [https://coussinsky.net/freshrss_feeds_2017-06-29.opml.xml](https://coussinsky.net/freshrss_feeds_2017-06-29.opml.xml){:rel="nofollow noreferrer"}
